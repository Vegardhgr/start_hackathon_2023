...
(5, 'Salt', NULL, 'grams'),
(6, 'Butter', NULL, 'grams'),
(7, 'Chocolate Chips', NULL, 'grams'),
(8, 'Vanilla Extract', NULL, 'milliliters'),
(9, 'Baking Powder', NULL, 'grams'),
(10, 'Olive Oil', NULL, 'milliliters'),
(11, 'Honey', NULL, 'milliliters'),
(12, 'Cinnamon', NULL, 'grams'),
(13, 'Yogurt', NULL, 'milliliters'),
(14, 'Lemon Juice', NULL, 'milliliters'),
(15, 'Brown Sugar', NULL, 'grams'),
(16, 'Cheddar Cheese', NULL, 'grams'),
(17, 'Tomatoes', NULL, 'pieces'),
(18, 'Basil', NULL, 'grams'),
(19, 'Onions', NULL, 'grams'),
(20, 'Pasta', NULL, 'grams'),
(21, 'Ground Beef', NULL, 'grams'),
(22, 'Lettuce', NULL, 'grams'),
(23, 'Apples', NULL, 'pieces'),
(24, 'Thyme', NULL, 'grams'),
(25, 'Oregano', NULL, 'grams'),
(26, 'Chicken Breast', NULL, 'grams'),
(27, 'Broccoli', NULL, 'grams'),
(28, 'Carrots', NULL, 'grams'),
(29, 'Parmesan Cheese', NULL, 'grams'),
(30, 'Soy Sauce', NULL, 'milliliters'),
(31, 'Garlic', NULL, 'grams'),
(32, 'Red Bell Pepper', NULL, 'grams'),
(33, 'Green Beans', NULL, 'grams'),
(34, 'Lamb Chops', NULL, 'grams'),
(35, 'Pineapple', NULL, 'grams'),
(36, 'Rice', NULL, 'grams'),
(37, 'Cucumber', NULL, 'grams'),
(38, 'Peanut Butter', NULL, 'grams'),
(39, 'Jelly', NULL, 'grams'),
(40, 'Bread', NULL, 'pieces');
